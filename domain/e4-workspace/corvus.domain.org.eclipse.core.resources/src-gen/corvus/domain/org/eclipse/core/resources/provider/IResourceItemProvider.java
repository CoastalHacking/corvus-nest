...
/**
 * This is the item provider adapter for a {@link corvus.domain.org.eclipse.core.resources.IResource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IResourceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IResource_parent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IResource_parent_feature", "_UI_IResource_type"),
				 ResourcesPackage.Literals.IRESOURCE__PARENT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IResource_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IResource_name_feature", "_UI_IResource_type"),
				 ResourcesPackage.Literals.IRESOURCE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ResourcesPackage.Literals.IRESOURCE__MARKERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ResourcesPackage.Literals.IRESOURCE__MARKERS,
				 ResourcesFactory.eINSTANCE.createIMarker()));

		newChildDescriptors.add
			(createChildParameter
				(ResourcesPackage.Literals.IRESOURCE__MARKERS,
				 ResourcesFactory.eINSTANCE.createTextMarker()));
	}
