...
public class EntryPointFrameworkItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EntryPointFramework_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EntryPointFramework_name_feature", "_UI_EntryPointFramework_type"),
				 EntrypointPackage.Literals.ENTRY_POINT_FRAMEWORK__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((EntryPointFramework)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_EntryPointFramework_type") :
			getString("_UI_EntryPointFramework_type") + " " + label;
	}
	...
	public ResourceLocator getResourceLocator() {
		return EntrypointEditPlugin.INSTANCE;
	}
