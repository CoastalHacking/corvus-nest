/**
 */
package corvus.model.link.util;

import corvus.model.link.*;
 ...
 * <!-- end-user-doc -->
 * @see corvus.model.link.LinkPackage
 * @generated
 */
public class LinkAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link corvus.model.link.Link <em>Link</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
